...
void setup() {
  ...
  keyMasterBedroom = new Item(KeyMasterBedroom, width/2-200, height/2-200,50,50,false,true,new InventoryItem(KeyMasterBedroom,100 + inventory.posX,150 + inventory.posY,false,"keyMasterBedroom"));
  ...
  pot = new Item(Pot,width/2-200, height/2+210,76,88);
  pot2 = new Item(Pot2,width/2-200, height/2+210,76,88);
  ...
  upstairHallScreen = new Screen(loadImage("backgrounds/upstairsHall.png"), "Upstairs Hall", new Arrow[]{new Arrow(width/2-200, height-190,400,25, 6), new Arrow(width-50,150,25,750,11), new Arrow(buttonXOffset,150,25,750,13), new Arrow(width/2-120, height/2+50,300,10,10)},false);
